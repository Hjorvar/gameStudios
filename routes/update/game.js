...
router.get('/', (req, res) => {
  ...
  if (username !== 'none') {
    ...
    res.render('createUpdate/game', {
      title: `Update ${game.name}`, action: 'Update', game, genres, studios, platforms, publishers, gameGenres, gamePlatforms, username,
    });
  } else {
    res.redirect(301, '/');
  }
...
router.post('/', (req, res) => {
  updateGame(dbFile, req.body.idGame, req.body.gameName, req.body.info, req.body.ytTrailer,
    req.body.year, req.body.month, req.body.studios, req.body.opencritic);
